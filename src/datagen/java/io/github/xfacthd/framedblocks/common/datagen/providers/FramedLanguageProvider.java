...
public final class FramedLanguageProvider extends LanguageProvider {
    ...
    private void addFramedBlockTranslations() {
        ...
        add(FBContent.BLOCK_FRAMED_COLLAPSIBLE_CUBE.value(), "Framed Collapsible Cube");
    ...
    private void addScreenTranslations() {
        ...
        add(SawRecipeFailurePrinter.TOOLTIP_HAVE_X_BUT_NEED_Y_ITEM, "Have %s, but need %s");
        add(SawRecipeFailurePrinter.TOOLTIP_HAVE_X_BUT_NEED_Y_ITEM_MULTI, "Have %s, but need %s or listed alternatives");
        add(SawRecipeFailurePrinter.TOOLTIP_HAVE_X_BUT_NEED_Y_TAG, "Have %s, but need any %s");
        add(SawRecipeFailurePrinter.TOOLTIP_HAVE_X_BUT_NEED_Y_ITEM_COUNT, "Have %s item(s), but need at least %s item(s)");
        add(SawRecipeFailurePrinter.TOOLTIP_HAVE_X_BUT_NEED_Y_MATERIAL_COUNT, "Have %s material, but need at least %s material");
        add(SawRecipeFailurePrinter.TOOLTIP_OUTPUT_COUNT, "Result size: %s, max size: %s");
        add(SawRecipeFailurePrinter.TOOLTIP_HAVE_ITEM_NONE, "none");
        add(SawRecipeFailurePrinter.TOOLTIP_PRESS_TO_SHOW, "Press [%s] to show all possible items");
        add(SawRecipeFailurePrinter.TOOLTIP_USE_INTERMEDIATE, "Use a smaller block as an intermediate step");
