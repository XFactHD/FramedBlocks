...
public enum BlockType implements IBlockType {
    ...
    FRAMED_HALF_SLOPE                               (false, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.MODEL, new HalfSlopeShapes()),
    FRAMED_VERTICAL_HALF_SLOPE                      (false, false,  true, false,  true, false,  true, ConTexMode.FULL_EDGE, Outline.MODEL, new VerticalHalfSlopeShapes()),
    FRAMED_DIVIDED_SLOPE                            ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.MODEL, SlopeShapes.INSTANCE),
    FRAMED_DOUBLE_HALF_SLOPE                        ( true,  true,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, DoubleHalfSlopeShapes::generate),
    FRAMED_VERTICAL_DOUBLE_HALF_SLOPE               ( true,  true,  true, false,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, CommonShapes.SLAB_GENERATOR),
    ...
    FRAMED_DOUBLE_CORNER                            ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    ...
    FRAMED_DOUBLE_PRISM_CORNER                      ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    ...
    FRAMED_DOUBLE_THREEWAY_CORNER                   ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_SLOPE_EDGE                               (false, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.MODEL, new SlopeEdgeShapes()),
    FRAMED_ELEVATED_SLOPE_EDGE                      ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, ElevatedSlopeEdgeShapes.INSTANCE),
    FRAMED_ELEVATED_DOUBLE_SLOPE_EDGE               ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_STACKED_SLOPE_EDGE                       ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.MODEL, ElevatedSlopeEdgeShapes.INSTANCE),
    ...
    FRAMED_SLOPE_EDGE_SLAB                          ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, new SlopeEdgeSlabShapes()),
    FRAMED_SLOPE_EDGE_PANEL                         ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, new SlopeEdgePanelShapes()),
    FRAMED_SLAB                                     ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, CommonShapes.SLAB_GENERATOR),
    FRAMED_DOUBLE_SLAB                              ( true, false, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_ADJ_DOUBLE_SLAB                          ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_ADJ_DOUBLE_COPYCAT_SLAB                  ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_DIVIDED_SLAB                             ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, CommonShapes.SLAB_GENERATOR),
    FRAMED_SLAB_EDGE                                (false, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, SlabEdgeShapes::generate),
    FRAMED_SLAB_CORNER                              (false, false,  true,  true,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, SlabCornerShapes::generate),
    FRAMED_PANEL                                    ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, CommonShapes.PANEL_GENERATOR),
    FRAMED_DOUBLE_PANEL                             ( true, false, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_ADJ_DOUBLE_PANEL                         ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_ADJ_DOUBLE_COPYCAT_PANEL                 ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_DIVIDED_PANEL_HORIZONTAL                 ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, CommonShapes.PANEL_GENERATOR),
    FRAMED_DIVIDED_PANEL_VERTICAL                   ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, CommonShapes.PANEL_GENERATOR),
    FRAMED_CORNER_PILLAR                            (false, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, CornerPillarShapes::generate),
    ...
    FRAMED_HALF_STAIRS                              (false, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, HalfStairsShapes::generate),
    FRAMED_DIVIDED_STAIRS                           ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE),
    FRAMED_DOUBLE_HALF_STAIRS                       ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, DoubleHalfStairsShapes::generate),
    ...
    FRAMED_SLOPED_STAIRS                            ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, SlopedStairsShapes.INSTANCE),
    FRAMED_SLOPED_DOUBLE_STAIRS                     ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_SLICED_SLOPED_STAIRS_SLAB                ( true,  true,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.MODEL, SlopedStairsShapes.INSTANCE),
    FRAMED_SLICED_SLOPED_STAIRS_SLOPE               ( true,  true,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.MODEL, SlopedStairsShapes.INSTANCE),
    ...
    FRAMED_VERTICAL_HALF_STAIRS                     (false, false,  true,  true, false, false,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, VerticalHalfStairsShapes::generate),
    ...
    FRAMED_VERTICAL_DOUBLE_HALF_STAIRS              ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, CommonShapes.SLAB_GENERATOR),
    ...
    FRAMED_VERTICAL_SLOPED_STAIRS                   ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, VerticalSlopedStairsShapes.INSTANCE),
    FRAMED_VERTICAL_SLOPED_DOUBLE_STAIRS            ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_VERTICAL_SLICED_SLOPED_STAIRS_PANEL      ( true,  true,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.MODEL, VerticalSlopedStairsShapes.INSTANCE),
    FRAMED_VERTICAL_SLICED_SLOPED_STAIRS_SLOPE      ( true,  true,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.MODEL, VerticalSlopedStairsShapes.INSTANCE),
    FRAMED_THREEWAY_CORNER_PILLAR                   (false, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, ThreewayCornerPillarShapes::generate),
    FRAMED_DOUBLE_THREEWAY_CORNER_PILLAR            ( true, false, false,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, Shapes.block()),
    ...
    FRAMED_FENCE_GATE                               (false, false, false,  true, false, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE),
    FRAMED_DOOR                                     ( true,  true, false,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE),
    FRAMED_IRON_DOOR                                ( true,  true, false,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE),
    FRAMED_TRAPDOOR                                 ( true, false,  true,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE),
    FRAMED_IRON_TRAPDOOR                            ( true, false,  true,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE),
    FRAMED_PRESSURE_PLATE                           (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_WATERLOGGABLE_PRESSURE_PLATE             (false, false,  true, false, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_STONE_PRESSURE_PLATE                     (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_WATERLOGGABLE_STONE_PRESSURE_PLATE       (false, false,  true, false, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_OBSIDIAN_PRESSURE_PLATE                  (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_WATERLOGGABLE_OBSIDIAN_PRESSURE_PLATE    (false, false,  true, false, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_GOLD_PRESSURE_PLATE                      (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_WATERLOGGABLE_GOLD_PRESSURE_PLATE        (false, false,  true, false, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_IRON_PRESSURE_PLATE                      (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_WATERLOGGABLE_IRON_PRESSURE_PLATE        (false, false,  true, false, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_LADDER                                   (false, false,  true,  true, false, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, new LadderShapes()),
    FRAMED_BUTTON                                   (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_STONE_BUTTON                             (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_LARGE_BUTTON                             (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_LARGE_STONE_BUTTON                       (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_LEVER                                    (false, false, false,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_SIGN                                     (false,  true,  true,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_WALL_SIGN                                (false,  true,  true, false, false, false,  true, null,                 Outline.SIMPLE, WallSignShapes::generate),
    FRAMED_HANGING_SIGN                             (false,  true,  true,  true, false, false,  true, null,                 Outline.SIMPLE, CeilingHangingSignShapes::generate),
    FRAMED_WALL_HANGING_SIGN                        (false,  true,  true, false, false, false,  true, null,                 Outline.SIMPLE),
    ...
    FRAMED_BOARD                                    ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, BoardShapes::generate),
    FRAMED_HALF_BOARD                               ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, BoardShapes::generateHalf),
    FRAMED_DIVIDED_BOARD                            ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, BoardShapes::generateDouble),
    FRAMED_CORNER_BOARD                             ( true, false,  true,  true,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, BoardShapes::generateCorner),
    ...
    FRAMED_TANK                                     ( true,  true, false,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    ...
    FRAMED_HORIZONTAL_PANE                          ( true, false,  true,  true,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, Block.box(0, 7, 0, 16, 9, 16)),
    FRAMED_RAIL_SLOPE                               ( true, false,  true,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.CUSTOM, SlopeShapes.INSTANCE),
    FRAMED_POWERED_RAIL_SLOPE                       ( true, false,  true,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.CUSTOM, SlopeShapes.INSTANCE),
    FRAMED_DETECTOR_RAIL_SLOPE                      ( true, false,  true,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.CUSTOM, SlopeShapes.INSTANCE),
    FRAMED_ACTIVATOR_RAIL_SLOPE                     ( true, false,  true,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.CUSTOM, SlopeShapes.INSTANCE),
    ...
    FRAMED_FANCY_RAIL_SLOPE                         ( true,  true,  true,  true, false,  true,  true, ConTexMode.FULL_FACE, Outline.CUSTOM, SlopeShapes.INSTANCE),
    FRAMED_FANCY_POWERED_RAIL_SLOPE                 ( true,  true,  true,  true, false,  true,  true, ConTexMode.FULL_FACE, Outline.CUSTOM, SlopeShapes.INSTANCE),
    FRAMED_FANCY_DETECTOR_RAIL_SLOPE                ( true,  true,  true,  true, false,  true,  true, ConTexMode.FULL_FACE, Outline.CUSTOM, SlopeShapes.INSTANCE),
    FRAMED_FANCY_ACTIVATOR_RAIL_SLOPE               ( true,  true,  true,  true, false,  true,  true, ConTexMode.FULL_FACE, Outline.CUSTOM, SlopeShapes.INSTANCE),
    FRAMED_FLOWER_POT                               (false,  true, false,  true, false, false,  true, null,                 Outline.SIMPLE, Block.box(5, 0, 5, 11, 6, 11)),
    FRAMED_PILLAR                                   (false, false,  true,  true,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, PillarShapes.PILLAR),
    FRAMED_HALF_PILLAR                              (false, false,  true,  true,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, HalfPillarShapes::generate),
    FRAMED_PILLAR_SOCKET                            ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, PillarSocketShapes::generate),
    FRAMED_SPLIT_PILLAR_SOCKET                      ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, PillarSocketShapes::generate),
    FRAMED_POST                                     (false, false,  true,  true,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, PillarShapes.POST),
    FRAMED_COLLAPSIBLE_BLOCK                        (false,  true,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.CUSTOM),
    FRAMED_COLLAPSIBLE_COPYCAT_BLOCK                (false,  true,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE),
    FRAMED_BOUNCY_CUBE                              ( true, false, false,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_REDSTONE_BLOCK                           ( true, false, false,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_PRISM                                    ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, PrismShapes.OUTER),
    FRAMED_ELEVATED_INNER_PRISM                     ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, ElevatedPrismShapes.INNER),
    FRAMED_ELEVATED_INNER_DOUBLE_PRISM              ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_SLOPED_PRISM                             ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, SlopedPrismShapes.OUTER),
    FRAMED_ELEVATED_INNER_SLOPED_PRISM              ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, ElevatedSlopedPrismShapes.INNER),
    FRAMED_ELEVATED_INNER_DOUBLE_SLOPED_PRISM       ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_SLOPE_SLAB                               ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, new SlopeSlabShapes()),
    FRAMED_ELEVATED_SLOPE_SLAB                      ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, ElevatedSlopeSlabShapes.INSTANCE),
    FRAMED_COMPOUND_SLOPE_SLAB                      ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.MODEL, InverseDoubleSlopeSlabShapes.INSTANCE),
    FRAMED_DOUBLE_SLOPE_SLAB                        ( true,  true,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, MoreCommonShapes.TOP_HALF_SLAB_GENERATOR),
    FRAMED_INV_DOUBLE_SLOPE_SLAB                    ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.MODEL, InverseDoubleSlopeSlabShapes.INSTANCE),
    FRAMED_ELEVATED_DOUBLE_SLOPE_SLAB               ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_STACKED_SLOPE_SLAB                       ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.MODEL, ElevatedSlopeSlabShapes.INSTANCE),
    ...
    FRAMED_SLOPE_PANEL                              ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, new SlopePanelShapes()),
    FRAMED_EXTENDED_SLOPE_PANEL                     ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, ExtendedSlopePanelShapes.INSTANCE),
    FRAMED_COMPOUND_SLOPE_PANEL                     ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_EDGE, Outline.MODEL, InverseDoubleSlopePanelShapes.INSTANCE),
    FRAMED_DOUBLE_SLOPE_PANEL                       ( true,  true,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, MoreCommonShapes.FRONT_INV_PANEL_GENERATOR),
    FRAMED_INV_DOUBLE_SLOPE_PANEL                   ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.MODEL, InverseDoubleSlopePanelShapes.INSTANCE),
    FRAMED_EXTENDED_DOUBLE_SLOPE_PANEL              ( true,  true, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_STACKED_SLOPE_PANEL                      ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.MODEL, ExtendedSlopePanelShapes.INSTANCE),
    ...
    FRAMED_PYRAMID                                  ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, PyramidShapes.FULL),
    FRAMED_PYRAMID_SLAB                             ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, PyramidShapes.SLAB),
    FRAMED_ELEVATED_PYRAMID_SLAB                    ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.MODEL, PyramidShapes.ELEVATED_SLAB),
    FRAMED_UPPER_PYRAMID_SLAB                       ( true, false,  true, false,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, PyramidShapes.UPPER_SLAB),
    FRAMED_STACKED_PYRAMID_SLAB                     ( true, false,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, Outline.MODEL, PyramidShapes.ELEVATED_SLAB),
    FRAMED_TARGET                                   ( true,  true, false,  true,  true, false, false, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_GATE                                     ( true, false, false,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, GateShapes::generate),
    FRAMED_IRON_GATE                                ( true, false, false,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, GateShapes::generate),
    ...
    FRAMED_ONE_WAY_WINDOW                           (false,  true, false,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_BOOKSHELF                                ( true, false, false,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_CHISELED_BOOKSHELF                       ( true,  true, false,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, Shapes.block()),
    FRAMED_CENTERED_SLAB                            ( true, false,  true,  true,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, Block.box(0, 4, 0, 16, 12, 16)),
    FRAMED_CENTERED_PANEL                           ( true, false,  true,  true,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, CenteredPanelShapes::generate),
    FRAMED_MASONRY_CORNER_SEGMENT                   (false, false,  true, false,  true, false,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, MasonryCornerSegmentShapes::generate),
    FRAMED_MASONRY_CORNER                           ( true, false, false,  true,  true,  true,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE, Shapes.block()),
    FRAMED_CHECKERED_CUBE_SEGMENT                   (false, false,  true, false,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, CheckeredCubeSegmentShapes::generate),
    FRAMED_CHECKERED_CUBE                           ( true, false, false,  true,  true,  true,  true, ConTexMode.DETAILED,  Outline.SIMPLE, Shapes.block()),
    FRAMED_CHECKERED_SLAB_SEGMENT                   (false, false,  true, false,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, CheckeredSlabSegmentShapes::generate),
    FRAMED_CHECKERED_SLAB                           ( true, false,  true,  true,  true,  true,  true, ConTexMode.DETAILED,  Outline.SIMPLE, CommonShapes.SLAB_GENERATOR),
    FRAMED_CHECKERED_PANEL_SEGMENT                  (false, false,  true, false,  true, false,  true, ConTexMode.DETAILED,  Outline.SIMPLE, CheckeredPanelSegmentShapes::generate),
    FRAMED_CHECKERED_PANEL                          ( true, false,  true,  true,  true,  true,  true, ConTexMode.DETAILED,  Outline.SIMPLE, CommonShapes.PANEL_GENERATOR),
    FRAMED_TUBE                                     ( true, false,  true,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, TubeShapes::generate),
    FRAMED_CORNER_TUBE                              ( true, false,  true,  true, false, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, CornerTubeShapes::generate),
    FRAMED_CHAIN                                    (false, false,  true,  true,  true, false, false, ConTexMode.DETAILED,  Outline.SIMPLE, ChainShapes::generate),
    FRAMED_LANTERN                                  (false, false,  true,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_SOUL_LANTERN                             (false, false,  true,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_COPPER_LANTERN                           (false, false,  true,  true, false, false,  true, null,                 Outline.SIMPLE),
    FRAMED_HOPPER                                   (false,  true, false,  true, false, false,  true, ConTexMode.FULL_EDGE, Outline.SIMPLE),
    FRAMED_LAYERED_CUBE                             ( true, false,  true,  true,  true, false,  true, ConTexMode.FULL_FACE, Outline.SIMPLE, LayeredCubeShapes::generate),
