...
public final class TargetCalculator {
    ...
    public static @Nullable HammerTarget computeTarget(FramedCollapsibleBlockEntity be, Player player, BlockHitResult blockHit, boolean relative, float partialTick) {
