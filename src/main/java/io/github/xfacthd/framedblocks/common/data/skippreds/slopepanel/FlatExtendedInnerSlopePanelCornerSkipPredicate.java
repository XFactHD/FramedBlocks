...
public final class FlatExtendedInnerSlopePanelCornerSkipPredicate implements SideSkipPredicate
{
    ...
    )
    {
        ...
        return SlopePanelDirs.FlatExtendedInnerSlopePanelCorner.getTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelDirs.FlatExtendedInnerSlopePanelCorner.getTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelDirs.FlatExtendedInnerSlopePanelCorner.getTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallInnerPrismSlopePanelCorner.getSideTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelDirs.FlatExtendedInnerSlopePanelCorner.getTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(adjDir, adjRot, side.getOpposite()));
    }
}
