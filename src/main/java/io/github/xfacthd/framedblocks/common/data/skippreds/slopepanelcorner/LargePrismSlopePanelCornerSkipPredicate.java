...
public final class LargePrismSlopePanelCornerSkipPredicate implements SideSkipPredicate
{
    @Override
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(dir, top, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(adjDir, adjTop, side.getOpposite())) ||
               SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(adjDir, adjTop, side.getOpposite())) ||
               SlopePanelCornerDirs.LargePrismSlopePanelCorner.getTopTriDir(dir, top, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCorner.getTopTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(SlopeDirs.Slope.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(SlopeDirs.VerticalHalfSlope.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(SlopeDirs.Corner.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(SlopeDirs.InnerCorner.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(SlopeDirs.ThreewayCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(SlopeDirs.InnerThreewayCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getTopTriDir(dir, top, side).isEqualTo(SlopeEdgeDirs.SlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getTopTriDir(dir, top, side).isEqualTo(SlopeEdgeDirs.CornerSlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getTopTriDir(dir, top, side).isEqualTo(SlopeEdgeDirs.InnerCornerSlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getTopTriDir(dir, top, side).isEqualTo(SlopeEdgeDirs.ThreewayCornerSlopeEdge.getTriDir(adjDir, adjTop, adjRight, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getTopTriDir(dir, top, side).isEqualTo(SlopeEdgeDirs.InnerThreewayCornerSlopeEdge.getTriDir(adjDir, adjTop, adjRight, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(StairsDirs.SlopedStairs.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(dir, top, side).isEqualTo(SlopePanelDirs.ExtendedSlopePanel.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(dir, top, side).isEqualTo(SlopePanelDirs.FlatExtendedSlopePanelCorner.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(dir, top, side).isEqualTo(SlopePanelDirs.FlatExtendedInnerSlopePanelCorner.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(dir, top, side).isEqualTo(SlopePanelCornerDirs.ExtendedCornerSlopePanel.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(dir, top, side).isEqualTo(SlopePanelCornerDirs.ExtendedInnerCornerSlopePanel.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getTopTriDir(dir, top, side).isEqualTo(SlopePanelCornerDirs.SmallPrismSlopePanelCorner.getBottomTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getSideTriDir(dir, top, side).isEqualTo(SlopePanelCornerDirs.SmallInnerPrismSlopePanelCorner.getSideTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(dir, top, side).isEqualTo(SlopePanelCornerDirs.LargeInnerPrismSlopePanelCorner.getTopTriDir(adjDir, adjTop, side.getOpposite()));
    }
}
