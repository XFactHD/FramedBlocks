...
public final class SmallPrismSlopePanelCornerWallSkipPredicate implements SideSkipPredicate
{
    @Override
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(adjDir, adjRot, side.getOpposite())) ||
               SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.SlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.CornerSlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.InnerCornerSlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.ThreewayCornerSlopeEdge.getTriDir(adjDir, adjTop, adjRight, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.InnerThreewayCornerSlopeEdge.getTriDir(adjDir, adjTop, adjRight, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.SlopeSlab.getTriDir(adjDir, adjTop, adjTopHalf, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.FlatSlopeSlabCorner.getTriDir(adjDir, adjTop, adjTopHalf, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.FlatInnerSlopeSlabCorner.getTriDir(adjDir, adjTop, adjTopHalf, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.SlopePanel.getTriDir(adjDir, adjRot, adjFront, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.FlatSlopePanelCorner.getTriDir(adjDir, adjRot, adjFront, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.FlatInnerSlopePanelCorner.getTriDir(adjDir, adjRot, adjFront, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallCornerSlopePanelWall.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargeInnerCornerSlopePanelWall.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargeInnerPrismSlopePanelCornerWall.getSideTriDir(adjDir, adjRot, side.getOpposite()));
    }
}
