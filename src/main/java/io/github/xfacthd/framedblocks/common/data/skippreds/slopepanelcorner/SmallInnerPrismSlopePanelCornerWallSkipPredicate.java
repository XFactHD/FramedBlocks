...
public final class SmallInnerPrismSlopePanelCornerWallSkipPredicate implements SideSkipPredicate
{
    @Override
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(adjDir, adjRot, side.getOpposite())) ||
               SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getFrontTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.ElevatedSlopeSlab.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.FlatElevatedSlopeSlabCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.FlatElevatedInnerSlopeSlabCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.ExtendedSlopePanel.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.FlatExtendedSlopePanelCorner.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.FlatExtendedInnerSlopePanelCorner.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.ExtendedCornerSlopePanelWall.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.ExtendedInnerCornerSlopePanelWall.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargeInnerPrismSlopePanelCornerWall.getBackTriDir(adjDir, adjRot, side.getOpposite()));
    }
}
