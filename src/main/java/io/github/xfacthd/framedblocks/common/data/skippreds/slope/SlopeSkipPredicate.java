...
public final class SlopeSkipPredicate implements SideSkipPredicate
{
    ...
    )
    {
        ...
        return SlopeDirs.Slope.getTriDir(dir, type, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCorner.getBottomTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.Slope.getTriDir(dir, type, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.Slope.getTriDir(dir, type, side).isEqualTo(SlopePanelCornerDirs.LargeInnerPrismSlopePanelCorner.getTopTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.Slope.getTriDir(dir, type, side).isEqualTo(SlopePanelCornerDirs.LargeInnerPrismSlopePanelCornerWall.getFrontTriDir(adjDir, adjRot, side.getOpposite()));
    }
}
