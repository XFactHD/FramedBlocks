...
public final class LargePrismSlopePanelCornerWallSkipPredicate implements SideSkipPredicate
{
    @Override
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(adjDir, adjRot, side.getOpposite())) ||
               SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(adjDir, adjRot, side.getOpposite())) ||
               SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeDirs.Slope.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeDirs.HalfSlope.getTriDir(adjDir, adjTop, adjRight, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeDirs.Corner.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeDirs.InnerCorner.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeDirs.ThreewayCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeDirs.InnerThreewayCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.SlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.CornerSlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.InnerCornerSlopeEdge.getTriDir(adjDir, adjType, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.ThreewayCornerSlopeEdge.getTriDir(adjDir, adjTop, adjRight, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopeEdgeDirs.InnerThreewayCornerSlopeEdge.getTriDir(adjDir, adjTop, adjRight, adjAlt, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(StairsDirs.VerticalSlopedStairs.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopeDirs.RailSlope.getTriDir(adjDir, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.ElevatedSlopeSlab.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.FlatElevatedSlopeSlabCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopeSlabDirs.FlatElevatedInnerSlopeSlabCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.ExtendedSlopePanel.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.FlatExtendedSlopePanelCorner.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelDirs.FlatExtendedInnerSlopePanelCorner.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.ExtendedCornerSlopePanelWall.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.ExtendedInnerCornerSlopePanelWall.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getFrontTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallPrismSlopePanelCornerWall.getBackTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getSideTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.SmallInnerPrismSlopePanelCornerWall.getSideTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopePanelCornerDirs.LargePrismSlopePanelCornerWall.getBackTriDir(dir, rot, side).isEqualTo(SlopePanelCornerDirs.LargeInnerPrismSlopePanelCornerWall.getFrontTriDir(adjDir, adjRot, side.getOpposite()));
    }
}
