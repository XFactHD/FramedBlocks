...
public final class ToggleYSlopeOverlay implements IIngameOverlay
{
    ...
    public void render(ForgeIngameGui gui, PoseStack poseStack, float partialTick, int width, int height)
    {
        ...
        Component textOne = new TranslatableComponent(SLOPE_MESSAGE, ySlope ? SLOPE_VERT : SLOPE_HOR);
        ...
        Component textTwo = new TranslatableComponent(TOGGLE_MESSAGE, ySlope ? SLOPE_HOR : SLOPE_VERT);
