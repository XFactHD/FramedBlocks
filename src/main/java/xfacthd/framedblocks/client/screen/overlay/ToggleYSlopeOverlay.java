...
public final class ToggleYSlopeOverlay extends BlockInteractOverlay
{
    ...
    private static final List<Component> LINES_FALSE = List.of(
            new TranslatableComponent(SLOPE_MESSAGE, SLOPE_HOR),
            new TranslatableComponent(TOGGLE_MESSAGE, SLOPE_VERT)
    );
    private static final List<Component> LINES_TRUE = List.of(
            new TranslatableComponent(SLOPE_MESSAGE, SLOPE_VERT),
            new TranslatableComponent(TOGGLE_MESSAGE, SLOPE_HOR)
    );
