...
public class OverlayLoader implements IModelLoader<OverlayGeometry>
{
    ...
    @Override
    public OverlayGeometry read(JsonDeserializationContext ctx, JsonObject obj) throws JsonParseException
    {
