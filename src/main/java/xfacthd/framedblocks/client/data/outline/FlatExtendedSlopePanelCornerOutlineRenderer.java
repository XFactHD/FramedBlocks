...
public final class FlatExtendedSlopePanelCornerOutlineRenderer implements OutlineRender
{
    @Override
    public void draw(BlockState state, PoseStack poseStack, VertexConsumer builder)
    {
        ...
        OutlineRender.drawLine(builder, poseStack, 1, 0, .5, 1, 0, 1);
        ...
        // Slopes
        OutlineRender.drawLine(builder, poseStack, 0, 0, 0, 1, 0, .5);
