...
public final class InverseDoubleCornerSlopePanelWallOutlineRenderer implements OutlineRenderer
{
    ...
    public void draw(BlockState state, PoseStack poseStack, VertexConsumer builder)
    {
        ...
        OutlineRenderer.drawLine(builder, poseStack, .5,  1, 0,  1,  1, 0);
        OutlineRenderer.drawLine(builder, poseStack,  1, .5, 0,  1,  1, 0);

        // Slopes
        OutlineRenderer.drawLine(builder, poseStack, .5,  1, 0,  0,  1, 1);
        OutlineRenderer.drawLine(builder, poseStack,  1, .5, 0,  1,  0, 1);
        OutlineRenderer.drawLine(builder, poseStack, .5, .5, 0,  0,  0, 1);
        OutlineRenderer.drawLine(builder, poseStack,  1,  1, 0, .5,  1, 1);
        OutlineRenderer.drawLine(builder, poseStack,  1,  1, 0,  1, .5, 1);
        OutlineRenderer.drawLine(builder, poseStack,  1,  1, 0, .5, .5, 1);
    }
