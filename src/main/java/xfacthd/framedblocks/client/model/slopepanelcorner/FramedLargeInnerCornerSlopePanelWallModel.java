...
public class FramedLargeInnerCornerSlopePanelWallModel extends FramedBlockModel
{
    ...
    public FramedLargeInnerCornerSlopePanelWallModel(BlockState state, BakedModel baseModel)
    {
