...
public class FramedExtendedInnerCornerSlopePanelWallModel extends FramedBlockModel
{
    ...
    public FramedExtendedInnerCornerSlopePanelWallModel(BlockState state, BakedModel baseModel)
    {
