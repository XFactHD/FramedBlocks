...
public class FramedExtendedCornerSlopePanelModel extends FramedBlockModel
{
    private final Direction dir;
    private final boolean top;
    private final boolean ySlope;

    public FramedExtendedCornerSlopePanelModel(BlockState state, BakedModel baseModel)
    {
