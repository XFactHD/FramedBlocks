...
public class FramedLargeInnerCornerSlopePanelModel extends FramedBlockModel
{
    private final Direction dir;
    private final boolean top;
    private final boolean ySlope;

    public FramedLargeInnerCornerSlopePanelModel(BlockState state, BakedModel baseModel)
    {
