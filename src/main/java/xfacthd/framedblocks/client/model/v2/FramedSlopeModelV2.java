...
public class FramedSlopeModelV2 extends FramedBlockModelV2
{
    private final Direction dir;
    private final SlopeType type;

    public FramedSlopeModelV2(BlockState state, IBakedModel baseModel)
    {
    ...
    public FramedSlopeModelV2(IBakedModel baseModel)
    {
        this(
                FBContent.blockFramedSlope.getDefaultState().with(PropertyHolder.FACING_HOR, Direction.SOUTH),
                baseModel
        );
    }
