...
public class FramedInnerCornerSlopeModelV2 extends FramedBlockModelV2
{
    private final Direction dir;
    private final CornerType type;

    public FramedInnerCornerSlopeModelV2(BlockState state, IBakedModel baseModel)
    {
    ...
    public FramedInnerCornerSlopeModelV2(IBakedModel baseModel)
    {
        this(
