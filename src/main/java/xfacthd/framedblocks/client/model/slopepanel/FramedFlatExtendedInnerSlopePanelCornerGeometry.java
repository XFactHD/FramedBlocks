...
public class FramedFlatExtendedInnerSlopePanelCornerGeometry implements Geometry
{
    ...
    {
        return FBContent.BLOCK_FRAMED_FLAT_EXTENDED_INNER_SLOPE_PANEL_CORNER.value()
                .defaultBlockState()
