...
public enum BlockType implements IBlockType
{
    ...
    FRAMED_WALL_BOARD                               ( true, false, false,  true,  true,  true, false, false, CtmPredicate.TOP, FramedWallBoardBlock.SKIP_PREDICATE, FramedWallBoardBlock::generateShapes),
