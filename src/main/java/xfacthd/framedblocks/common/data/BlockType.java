...
public enum BlockType implements IBlockType
{
    ...
    FRAMED_DOUBLE_STAIRS                            ( true, false, false, false,  true,  true,  true,  true, ConTexMode.FULL_FACE, ShapeGenerator.EMPTY),
    ...
    FRAMED_DIVIDED_STAIRS                           ( true, false, false,  true,  true,  true,  true,  true, ConTexMode.FULL_EDGE, ShapeGenerator.EMPTY),
    ...
    FRAMED_SLICED_STAIRS_SLAB                       ( true, false, false,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, ShapeGenerator.EMPTY),
    FRAMED_SLICED_STAIRS_PANEL                      ( true, false, false,  true,  true,  true,  true,  true, ConTexMode.FULL_FACE, ShapeGenerator.EMPTY),
