...
public enum BlockType
{
    ...
    FRAMED_DOOR                   (false, false, false,  true, FramedDoorBlock.CTM_PREDICATE, new DoorSkipPredicate()),
    ...
    FRAMED_DOUBLE_SLAB            (false,  true, false,  true, CtmPredicate.Y_AXIS, SideSkipPredicate.FALSE, VoxelShapes.fullCube()), //Side skip is handled by the single slab
    FRAMED_DOUBLE_PANEL           (false,  true, false,  true, FramedDoublePanelBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, VoxelShapes.fullCube()), //Side skip is handled by the single panel
    ...
    FRAMED_FLOWER_POT             (false,  true, false,  true, CtmPredicate.FALSE, SideSkipPredicate.FALSE, VoxelShapes.create(5D/16D, 0, 5D/16D, 11D/16D, 6D/16D, 11D/16D)),
