...
{
    FRAMED_CUBE                   (false, false,  true,  true,  true, CtmPredicate.TRUE, SideSkipPredicate.CTM, VoxelShapes.fullCube()),
    ...
    FRAMED_DOUBLE_SLAB            (false,  true,  true,  true,  true, CtmPredicate.Y_AXIS, SideSkipPredicate.FALSE, VoxelShapes.fullCube()), //Side skip is handled by the single slab
    FRAMED_DOUBLE_PANEL           (false,  true,  true,  true,  true, FramedDoublePanelBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, VoxelShapes.fullCube()), //Side skip is handled by the single panel
    FRAMED_DOUBLE_SLOPE           (false,  true,  true,  true,  true, FramedDoubleSlopeBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, VoxelShapes.fullCube()), //Side skip is handled by the single slope
    FRAMED_DOUBLE_CORNER          (false,  true,  true,  true,  true, FramedDoubleCornerBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, VoxelShapes.fullCube()),
    FRAMED_DOUBLE_PRISM_CORNER    (false,  true,  true,  true,  true, FramedDoubleThreewayCornerBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, VoxelShapes.fullCube()),
    FRAMED_DOUBLE_THREEWAY_CORNER (false,  true,  true,  true,  true, FramedDoubleThreewayCornerBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, VoxelShapes.fullCube()),
    ...
    FRAMED_BOUNCY_CUBE            (false, false,  true,  true, false, CtmPredicate.TRUE, SideSkipPredicate.CTM, VoxelShapes.fullCube()),
    FRAMED_SECRET_STORAGE         (false,  true,  true,  true, false, CtmPredicate.TRUE, SideSkipPredicate.CTM, VoxelShapes.fullCube());
