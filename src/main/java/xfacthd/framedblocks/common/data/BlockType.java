...
{
    FRAMED_CUBE                   ( true, false, false, false,  true,  true, CtmPredicate.TRUE, SideSkipPredicate.CTM, Shapes.block()),
    ...
    FRAMED_DOUBLE_SLAB            ( true, false,  true, false,  true,  true, CtmPredicate.Y_AXIS, SideSkipPredicate.FALSE, Shapes.block()), //Side skip is handled by the single slab
    FRAMED_DOUBLE_PANEL           ( true, false,  true, false,  true,  true, FramedDoublePanelBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, Shapes.block()), //Side skip is handled by the single panel
    FRAMED_DOUBLE_SLOPE           ( true, false,  true, false,  true,  true, FramedDoubleSlopeBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, Shapes.block()), //Side skip is handled by the single slope
    FRAMED_DOUBLE_CORNER          ( true, false,  true, false,  true,  true, FramedDoubleCornerBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, Shapes.block()),
    FRAMED_DOUBLE_PRISM_CORNER    ( true, false,  true, false,  true,  true, FramedDoubleThreewayCornerBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, Shapes.block()),
    FRAMED_DOUBLE_THREEWAY_CORNER ( true, false,  true, false,  true,  true, FramedDoubleThreewayCornerBlock.CTM_PREDICATE, SideSkipPredicate.FALSE, Shapes.block()),
	...
	FRAMED_FLOOR_BOARD            ( true, false, false,  true,  true,  true, FramedFloorBlock.CTM_PREDICATE, FramedFloorBlock.SKIP_PREDICATE, Shapes.box(0, 0, 0, 1, 1D/16D, 1)),
    ...
    FRAMED_CHEST                  (false, false,  true,  true,  true, false, CtmPredicate.FALSE, SideSkipPredicate.FALSE, Shapes.box(1D/16D, 0, 1D/16D, 15D/16D, 14D/16D, 15D/16D)),
    ...
    FRAMED_FLOWER_POT             (false, false,  true, false,  true, false, CtmPredicate.FALSE, SideSkipPredicate.FALSE, Shapes.box(5D/16D, 0, 5D/16D, 11D/16D, 6D/16D, 11D/16D)),
