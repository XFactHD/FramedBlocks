...
public enum BlockType implements IBlockType
{
    ...
    FRAMED_DOUBLE_STAIRS                            ( true, false, false, false,  true,  true,  true, false, ConTexMode.FULL_FACE, Shapes.block()),
    ...
    FRAMED_DIVIDED_STAIRS                           ( true, false, false,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, FramedDividedStairsBlock::generateShapes),
    ...
    FRAMED_SLICED_STAIRS_SLAB                       ( true, false, false,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FramedDividedStairsBlock::generateShapes),
    FRAMED_SLICED_STAIRS_PANEL                      ( true, false, false,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FramedDividedStairsBlock::generateShapes),
    ...
    FRAMED_VERTICAL_DOUBLE_STAIRS                   ( true, false, false, false,  true,  true,  true, false, ConTexMode.FULL_FACE, Shapes.block()),
    ...
    FRAMED_VERTICAL_DIVIDED_STAIRS                  ( true, false, false,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, FramedVerticalDividedStairsBlock::generateShapes),
    ...
    FRAMED_VERTICAL_SLICED_STAIRS                   ( true, false, false,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FramedVerticalSlicedStairsBlock::generateShapes),
