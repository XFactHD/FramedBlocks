...
public enum BlockType
{
    ...
    FRAMED_PRISM_CORNER           ( true, false,  true,  true, CtmPredicate.FALSE, FramedThreewayCornerBlock.SKIP_PREDICATE, FramedPrismCornerBlock::generatePrismShapes),
    FRAMED_INNER_PRISM_CORNER     ( true, false,  true,  true, FramedThreewayCornerBlock.CTM_PREDICATE, FramedThreewayCornerBlock.SKIP_PREDICATE_INNER, FramedPrismCornerBlock::generateInnerPrismShapes),
