...
public enum BlockType implements IBlockType
{
    ...
    FRAMED_GATE                                     (false, false, false,  true,  true, false, false, false, CtmPredicate.FALSE, FramedFenceGateBlock.SKIP_PREDICATE), //TODO: rename to FRAMED_FENCE_GATE in 1.20
    ...
    FRAMED_PRESSURE_PLATE                           (false, false, false,  true,  true, false, false, false),
    FRAMED_STONE_PRESSURE_PLATE                     (false, false, false,  true,  true, false, false, false),
    FRAMED_OBSIDIAN_PRESSURE_PLATE                  (false, false, false,  true,  true, false, false, false),
    FRAMED_GOLD_PRESSURE_PLATE                      (false, false, false,  true,  true, false, false, false),
    FRAMED_IRON_PRESSURE_PLATE                      (false, false, false,  true,  true, false, false, false),
