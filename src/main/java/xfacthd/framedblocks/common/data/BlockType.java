...
public enum BlockType implements IBlockType
{
    ...
    FRAMED_SLICED_STAIRS_SLAB                       ( true, false,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FramedDividedStairsBlock::generateShapes),
    FRAMED_SLICED_STAIRS_PANEL                      ( true, false,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FramedDividedStairsBlock::generateShapes),
