...
{
    FRAMED_CUBE                                     ( true, false, false, false,  true,  true, false, false, FullFacePredicate.TRUE, SideSkipPredicate.CTM, Shapes.block()),
    ...
    FRAMED_PRISM_CORNER                             ( true,  true, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new ThreewayCornerSkipPredicate(), FramedPrismCornerBlock::generatePrismShapes),
    ...
    FRAMED_THREEWAY_CORNER                          ( true,  true, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new ThreewayCornerSkipPredicate(), FramedThreewayCornerBlock::generateThreewayShapes),
    ...
    FRAMED_SLAB                                     ( true, false, false,  true,  true,  true, false, false, FullFacePredicate.TOP, new SlabSkipPredicate(), FramedSlabBlock::generateShapes),
    FRAMED_SLAB_EDGE                                (false, false, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new SlabEdgeSkipPredicate(), FramedSlabEdgeBlock::generateShapes),
    FRAMED_SLAB_CORNER                              (false, false, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new SlabCornerSkipPredicate(), FramedSlabCornerBlock::generateShapes),
    FRAMED_DIVIDED_SLAB                             ( true, false,  true,  true,  true,  true,  true, false, FramedSlabBlock::generateShapes),
    FRAMED_PANEL                                    ( true, false, false,  true,  true,  true, false, false, FullFacePredicate.HOR_DIR, new PanelSkipPredicate(), FramedPanelBlock::generateShapes),
    FRAMED_CORNER_PILLAR                            (false, false, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new CornerPillarSkipPredicate(), FramedCornerPillarBlock::generateShapes),
    ...
    FRAMED_HALF_STAIRS                              (false, false, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new HalfStairsSkipPredicate(), FramedHalfStairsBlock::generateShapes),
    ...
    FRAMED_VERTICAL_HALF_STAIRS                     (false, false, false,  true,  true, false, false, false, FullFacePredicate.FALSE, new VerticalHalfStairsSkipPredicate(), FramedVerticalHalfStairsBlock::generateShapes),
    FRAMED_VERTICAL_DIVIDED_STAIRS                  ( true, false,  true,  true,  true,  true,  true, false, FramedVerticalDividedStairsBlock::generateShapes),
    FRAMED_WALL                                     (false, false, false,  true,  true, false, false,  true, FullFacePredicate.FALSE, new WallSkipPredicate()),
    FRAMED_FENCE                                    (false, false, false,  true,  true, false, false,  true, FullFacePredicate.FALSE, new FenceSkipPredicate()),
    FRAMED_FENCE_GATE                               (false, false, false,  true,  true, false, false, false, FullFacePredicate.FALSE, new FenceGateSkipPredicate()),
    ...
    FRAMED_DOUBLE_SLAB                              ( true, false,  true, false,  true,  true,  true, false, FullFacePredicate.Y_AXIS, Shapes.block()),
    ...
    FRAMED_FLOOR_BOARD                              ( true, false, false,  true,  true,  true, false, false, FullFacePredicate.TOP, new FloorBoardSkipPredicate(), FramedFloorBlock::generateShapes),
    FRAMED_WALL_BOARD                               ( true, false, false,  true,  true,  true, false, false, FullFacePredicate.HOR_DIR, new WallBoardSkipPredicate(), FramedWallBoardBlock::generateShapes),
    FRAMED_LATTICE_BLOCK                            (false, false, false,  true,  true,  true, false,  true, FullFacePredicate.FALSE, new LatticeSkipPredicate(), FramedLatticeBlock::generateShapes),
    FRAMED_CHEST                                    (false, false,  true,  true,  true, false, false, false, Shapes.box(1D/16D, 0, 1D/16D, 15D/16D, 14D/16D, 15D/16D)),
    FRAMED_SECRET_STORAGE                           ( true, false,  true, false,  true, false, false, false, FullFacePredicate.TRUE, SideSkipPredicate.CTM, Shapes.block()),
    FRAMED_BARS                                     (false, false, false,  true,  true,  true, false,  true),
    FRAMED_PANE                                     (false, false, false,  true,  true,  true, false,  true, FullFacePredicate.FALSE, new PaneSkipPredicate()),
    FRAMED_HORIZONTAL_PANE                          ( true, false, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new HorizontalPaneSkipPredicate(), Shapes.box(0, 7D/16D, 0, 1, 9D/16D, 1)),
    ...
    FRAMED_PILLAR                                   (false, false, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new PillarSkipPredicate(), FramedPillarBlock::generatePillarShapes),
    FRAMED_HALF_PILLAR                              (false, false, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new HalfPillarSkipPredicate(), FramedHalfPillarBlock::generateShapes),
    FRAMED_POST                                     (false, false, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new PostSkipPredicate(), FramedPillarBlock::generatePostShapes),
    ...
    FRAMED_BOUNCY_CUBE                              ( true, false, false, false,  true, false, false, false, FullFacePredicate.TRUE, SideSkipPredicate.CTM, Shapes.block()),
    FRAMED_REDSTONE_BLOCK                           ( true, false, false, false,  true,  true, false, false, FullFacePredicate.TRUE, SideSkipPredicate.CTM, Shapes.block()),
    ...
    FRAMED_STACKED_SLOPE_SLAB                       ( true,  true,  true,  true,  true,  true,  true, false, FullFacePredicate.TOP, FramedElevatedSlopeSlabBlock::generateShapes),
    ...
    FRAMED_FLAT_ELEV_DOUBLE_SLOPE_SLAB_CORNER       ( true, false,  true, false,  true,  true,  true, false, FullFacePredicate.Y_AXIS, Shapes.block()),
    ...
    FRAMED_FLAT_STACKED_SLOPE_SLAB_CORNER           ( true,  true,  true,  true,  true,  true,  true, false, FullFacePredicate.TOP, FramedFlatElevatedSlopeSlabCornerBlock::generateShapes),
    FRAMED_FLAT_STACKED_INNER_SLOPE_SLAB_CORNER     ( true,  true,  true,  true,  true,  true,  true, false, FullFacePredicate.TOP, FramedFlatElevatedSlopeSlabCornerBlock::generateInnerShapes),
    ...
    FRAMED_STACKED_SLOPE_PANEL                      ( true,  true,  true,  true,  true,  true,  true, false, FullFacePredicate.HOR_DIR, FramedExtendedSlopePanelBlock::generateShapes),
    ...
    FRAMED_FLAT_EXT_SLOPE_PANEL_CORNER              ( true,  true, false,  true,  true,  true, false, false, FullFacePredicate.HOR_DIR, new FlatExtendedSlopePanelCornerSkipPredicate(), FramedFlatExtendedSlopePanelCornerBlock::generateShapes),
    ...
    FRAMED_FLAT_EXT_DOUBLE_SLOPE_PANEL_CORNER       ( true, false,  true, false,  true,  true,  true, false, FullFacePredicate.HOR_DIR_AXIS, Shapes.block()),
    ...
    FRAMED_FLAT_STACKED_SLOPE_PANEL_CORNER          ( true,  true,  true,  true,  true,  true,  true, false, FullFacePredicate.HOR_DIR, FramedFlatExtendedSlopePanelCornerBlock::generateShapes),
    FRAMED_FLAT_STACKED_INNER_SLOPE_PANEL_CORNER    ( true,  true,  true,  true,  true,  true,  true, false, FullFacePredicate.HOR_DIR, FramedFlatExtendedSlopePanelCornerBlock::generateInnerShapes),
    FRAMED_GLOWING_CUBE                             ( true, false, false, false,  true,  true, false, false, FullFacePredicate.TRUE, SideSkipPredicate.CTM, Shapes.block()),
    FRAMED_PYRAMID                                  ( true,  true, false,  true,  true,  true, false, false, FullFacePredicate.DIR_OPPOSITE, SideSkipPredicate.CTM, FramedPyramidBlock::generateShapes),
    FRAMED_PYRAMID_SLAB                             ( true,  true, false,  true,  true,  true, false, false, FullFacePredicate.DIR_OPPOSITE, SideSkipPredicate.CTM, FramedPyramidBlock::generateSlabShapes),
    FRAMED_TARGET                                   ( true, false,  true, false,  true,  true, false, false, FullFacePredicate.TRUE, SideSkipPredicate.CTM, Shapes.block()),
    ...
    FRAMED_FANCY_RAIL                               (false, false, false,  true,  true, false, false, false, FullFacePredicate.FALSE, SideSkipPredicate.FALSE),
    FRAMED_FANCY_POWERED_RAIL                       (false, false, false,  true,  true, false, false, false, FullFacePredicate.FALSE, SideSkipPredicate.FALSE),
    FRAMED_FANCY_DETECTOR_RAIL                      (false, false, false,  true,  true, false, false, false, FullFacePredicate.FALSE, SideSkipPredicate.FALSE),
    FRAMED_FANCY_ACTIVATOR_RAIL                     (false, false, false,  true,  true, false, false, false, FullFacePredicate.FALSE, SideSkipPredicate.FALSE),
    FRAMED_FANCY_RAIL_SLOPE                         ( true,  true, false,  true,  true, false,  true, false, FullFacePredicate.FALSE, SideSkipPredicate.FALSE, FramedSlopeBlock::generateShapes),
    FRAMED_FANCY_POWERED_RAIL_SLOPE                 ( true,  true, false,  true,  true, false,  true, false, FullFacePredicate.FALSE, SideSkipPredicate.FALSE, FramedSlopeBlock::generateShapes),
    FRAMED_FANCY_DETECTOR_RAIL_SLOPE                ( true,  true, false,  true,  true, false,  true, false, FullFacePredicate.FALSE, SideSkipPredicate.FALSE, FramedSlopeBlock::generateShapes),
    FRAMED_FANCY_ACTIVATOR_RAIL_SLOPE               ( true,  true, false,  true,  true, false,  true, false, FullFacePredicate.FALSE, SideSkipPredicate.FALSE, FramedSlopeBlock::generateShapes),
    FRAMED_HALF_SLOPE                               (false,  true, false,  true,  true,  true, false, false, FullFacePredicate.FALSE, new HalfSlopeSkipPredicate(), FramedHalfSlopeBlock::generateShapes),
    FRAMED_VERTICAL_HALF_SLOPE                      (false,  true, false,  true, false,  true, false, false, FullFacePredicate.FALSE, new VerticalHalfSlopeSkipPredicate(), FramedVerticalHalfSlopeBlock::generateShapes),
    ...
    {
        this(canOcclude, specialHitbox, specialTile, waterloggable, blockItem, allowIntangible, doubleBlock, lockable, FullFacePredicate.FALSE, SideSkipPredicate.FALSE, ShapeGenerator.EMPTY);
    }
    ...
    {
        this(canOcclude, specialHitbox, specialTile, waterloggable, blockItem, allowIntangible, doubleBlock, lockable, FullFacePredicate.FALSE, SideSkipPredicate.FALSE, shape);
    }
    ...
    {
        this(canOcclude, specialHitbox, specialTile, waterloggable, blockItem, allowIntangible, doubleBlock, lockable, FullFacePredicate.FALSE, SideSkipPredicate.FALSE, shapeGen);
    }

    BlockType(boolean canOcclude, boolean specialHitbox, boolean specialTile, boolean waterloggable, boolean blockItem, boolean allowIntangible, boolean doubleBlock, boolean lockable, FullFacePredicate fullFacePredicate, VoxelShape shape)
    {
        this(canOcclude, specialHitbox, specialTile, waterloggable, blockItem, allowIntangible, doubleBlock, lockable, fullFacePredicate, SideSkipPredicate.FALSE, shape);
    }

    BlockType(boolean canOcclude, boolean specialHitbox, boolean specialTile, boolean waterloggable, boolean blockItem, boolean allowIntangible, boolean doubleBlock, boolean lockable, FullFacePredicate fullFacePredicate, ShapeGenerator shapeGen)
    {
        this(canOcclude, specialHitbox, specialTile, waterloggable, blockItem, allowIntangible, doubleBlock, lockable, fullFacePredicate, SideSkipPredicate.FALSE, shapeGen);
    }

    BlockType(boolean canOcclude, boolean specialHitbox, boolean specialTile, boolean waterloggable, boolean blockItem, boolean allowIntangible, boolean doubleBlock, boolean lockable, FullFacePredicate fullFacePredicate, SideSkipPredicate skipPredicate)
    {
        this(canOcclude, specialHitbox, specialTile, waterloggable, blockItem, allowIntangible, doubleBlock, lockable, fullFacePredicate, skipPredicate, ShapeGenerator.EMPTY);
    }

    BlockType(boolean canOcclude, boolean specialHitbox, boolean specialTile, boolean waterloggable, boolean blockItem, boolean allowIntangible, boolean doubleBlock, boolean lockable, FullFacePredicate fullFacePredicate, SideSkipPredicate skipPredicate, VoxelShape shape)
    {
        this(canOcclude, specialHitbox, specialTile, waterloggable, blockItem, allowIntangible, doubleBlock, lockable, fullFacePredicate, skipPredicate, ShapeGenerator.singleShape(shape));
    ...
    BlockType(boolean canOcclude, boolean specialHitbox, boolean specialTile, boolean waterloggable, boolean blockItem, boolean allowIntangible, boolean doubleBlock, boolean lockable, FullFacePredicate fullFacePredicate, SideSkipPredicate skipPredicate, ShapeGenerator shapeGen)
    {
