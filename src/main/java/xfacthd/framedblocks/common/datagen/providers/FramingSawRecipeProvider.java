...
{
    public FramingSawRecipeProvider(DataGenerator generator)
    {
        super(generator);
    }
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer)
    {
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedIronDoor)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 2)
                .additive(Ingredient.of(Tags.Items.INGOTS_IRON), 2)
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedIronTrapDoor)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 4)
                .additive(Ingredient.of(Tags.Items.INGOTS_IRON))
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedLever)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 4)
                .additive(Ingredient.of(Tags.Items.COBBLESTONE))
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedTorch, 4)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 4)
                .additive(Ingredient.of(ItemTags.COALS))
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.blockFramedSoulTorch)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 4)
                .additives(Map.of(
                        Ingredient.of(ItemTags.COALS), 1,
                        Ingredient.of(Items.SOUL_SAND), 1
                ))
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedRedstoneTorch, 4)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 4)
                .additive(Ingredient.of(Tags.Items.DUSTS_REDSTONE))
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedSecretStorage)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE * 4)
                .additive(Ingredient.of(FBContent.blockFramedChest.get()))
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedBouncyCube)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE)
                .additive(Ingredient.of(Tags.Items.SLIMEBALLS), 4)
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.blockFramedRedstoneBlock)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE)
                .additive(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 8)
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedGlowingCube)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE)
                .additive(Ingredient.of(Tags.Items.DUSTS_GLOWSTONE), 4)
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedTarget)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE)
                .additives(Map.of(
                        Ingredient.of(Items.HAY_BLOCK), 1,
                        Ingredient.of(Tags.Items.DUSTS_REDSTONE), 4
                ))
                .disabled() // TODO: Needs more than 1 additive
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedGlowingItemFrame)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 4)
                .additives(Map.of(
                        Ingredient.of(Tags.Items.LEATHER), 1,
                        Ingredient.of(Items.GLOW_INK_SAC), 1
                ))
                .disabled() // TODO: Needs more than 1 additive
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedItemFrame)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 4)
                .additive(Ingredient.of(Tags.Items.LEATHER))
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.blockFramedFancyRail, 16)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE)
                .additive(Ingredient.of(Tags.Items.INGOTS_IRON), 6)
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.blockFramedFancyPoweredRail, 6)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE)
                .additives(Map.of(
                        Ingredient.of(Tags.Items.INGOTS_GOLD), 6,
                        Ingredient.of(Tags.Items.DUSTS_REDSTONE), 1
                ))
                .disabled() // TODO: Needs more than 1 additive
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedFancyDetectorRail, 6)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE)
                .additives(Map.of(
                        Ingredient.of(Tags.Items.INGOTS_IRON), 6,
                        Ingredient.of(Tags.Items.DUSTS_REDSTONE), 1,
                        Ingredient.of(Items.STONE_PRESSURE_PLATE), 1
                ))
                .disabled() // TODO: Needs more than 1 additive
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedFancyActivatorRail, 6)
                ...
                .additives(Map.of(
                        Ingredient.of(Tags.Items.INGOTS_IRON), 6,
                        Ingredient.of(Items.REDSTONE_TORCH), 1
                ))
                .disabled() // TODO: Needs more than 1 additive
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.blockFramedFancyRailSlope)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 2)
                .additive(Ingredient.of(FBContent.blockFramedFancyRail.get()))
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.blockFramedFancyPoweredRailSlope)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 2)
                .additive(Ingredient.of(FBContent.blockFramedFancyPoweredRail.get()))
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.blockFramedFancyDetectorRailSlope)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 2)
                .additive(Ingredient.of(FBContent.blockFramedFancyDetectorRail.get()))
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.blockFramedFancyActivatorRailSlope)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 2)
                .additive(Ingredient.of(FBContent.blockFramedFancyActivatorRail.get()))
                .save(consumer);
