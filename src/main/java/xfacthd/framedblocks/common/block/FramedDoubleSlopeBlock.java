...
public class FramedDoubleSlopeBlock extends AbstractFramedDoubleBlock
{
    ...
    {
        BlockState state = withWater(getDefaultState(), context.getWorld(), context.getPos());
        return withSlopeType(state, context.getFace(), context.getPlacementHorizontalFacing(), context.getHitVec());
    }
